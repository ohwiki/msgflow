...
## 项目位置
- 排版器代码：`/home/administrator/workspace/open-source/msgflow/worker/src/formatter/`
- 主题文件目录：`/home/administrator/workspace/open-source/msgflow/worker/src/formatter/themes/`
...
3. 部署：`cd worker && npx wrangler deploy --env production`
...
## 验证命令
```bash
cd /home/administrator/workspace/open-source/msgflow/worker
npx tsc --noEmit          # 类型检查
npx vitest run            # 运行测试
